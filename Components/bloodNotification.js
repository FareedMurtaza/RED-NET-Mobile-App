            ...
            <View style={styles.itemContainer} >
                ...
                <View style={styles.rightInfo} >
                    <View style={{ flexDirection: 'column' }}>
                        ...
                        <Text>
                            <Text style={{ ...styles.bold, ...{ fontSize: 20 } }}> Location:</Text>
                            <Text style={{ fontSize: 19 }}> {props.item.locationTo}</Text>
                        </Text>

                        <Text>
                            <Text style={{ ...styles.bold, ...styles.size }}> Distance: </Text>
                    ...
                    <View style={styles.buttonContainer} >
                        ...
                        <View style={styles.button} ><Button title="Want to Donate" color="dodgerblue" /></View>
                    </View>
                </View>
            </View>
        </TouchableOpacity>
